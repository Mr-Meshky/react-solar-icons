...
interface DownloadMinimalisticBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const DownloadMinimalisticBold = forwardRef<
  SVGSVGElement,
  DownloadMinimalisticBoldProps
...
DownloadMinimalisticBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
