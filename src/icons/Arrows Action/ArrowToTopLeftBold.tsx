...
interface ArrowToTopLeftBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const ArrowToTopLeftBold = forwardRef<SVGSVGElement, ArrowToTopLeftBoldProps>(
...
ArrowToTopLeftBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
