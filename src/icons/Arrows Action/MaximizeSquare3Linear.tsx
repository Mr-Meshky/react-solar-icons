...
interface MaximizeSquare3LinearProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const MaximizeSquare3Linear = forwardRef<
  SVGSVGElement,
  MaximizeSquare3LinearProps
...
MaximizeSquare3Linear.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
