...
interface Logout3OutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const Logout3Outline = forwardRef<SVGSVGElement, Logout3OutlineProps>(
...
Logout3Outline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default Logout3Outline;
