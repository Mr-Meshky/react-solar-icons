...
interface UndoRightSquareOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const UndoRightSquareOutline = forwardRef<
  SVGSVGElement,
  UndoRightSquareOutlineProps
...
UndoRightSquareOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default UndoRightSquareOutline;
