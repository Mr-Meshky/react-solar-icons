...
interface UndoLeftOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const UndoLeftOutline = forwardRef<SVGSVGElement, UndoLeftOutlineProps>(
