...
interface MaximizeOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const MaximizeOutline = forwardRef<SVGSVGElement, MaximizeOutlineProps>(
