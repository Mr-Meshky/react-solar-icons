...
interface CircleTopDownOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CircleTopDownOutline = forwardRef<
  SVGSVGElement,
  CircleTopDownOutlineProps
...
CircleTopDownOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
