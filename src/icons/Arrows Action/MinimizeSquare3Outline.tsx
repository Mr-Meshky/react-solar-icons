...
interface MinimizeSquare3OutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const MinimizeSquare3Outline = forwardRef<
  SVGSVGElement,
  MinimizeSquare3OutlineProps
...
MinimizeSquare3Outline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default MinimizeSquare3Outline;
