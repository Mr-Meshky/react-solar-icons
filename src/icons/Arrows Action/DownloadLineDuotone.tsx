...
interface DownloadLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const DownloadLineDuotone = forwardRef<SVGSVGElement, DownloadLineDuotoneProps>(
...
DownloadLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
