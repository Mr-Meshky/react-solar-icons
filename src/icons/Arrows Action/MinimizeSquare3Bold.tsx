...
interface MinimizeSquare3BoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const MinimizeSquare3Bold = forwardRef<SVGSVGElement, MinimizeSquare3BoldProps>(
...
MinimizeSquare3Bold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
