...
interface MinimizeSquare2OutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const MinimizeSquare2Outline = forwardRef<
  SVGSVGElement,
  MinimizeSquare2OutlineProps
...
MinimizeSquare2Outline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default MinimizeSquare2Outline;
