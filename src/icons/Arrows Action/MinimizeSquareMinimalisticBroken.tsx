...
interface MinimizeSquareMinimalisticBrokenProps
...
const MinimizeSquareMinimalisticBroken = forwardRef<
  SVGSVGElement,
  MinimizeSquareMinimalisticBrokenProps
...
MinimizeSquareMinimalisticBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
