...
interface UndoRightRoundBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const UndoRightRoundBold = forwardRef<SVGSVGElement, UndoRightRoundBoldProps>(
...
UndoRightRoundBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
