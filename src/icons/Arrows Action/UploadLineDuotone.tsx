...
interface UploadLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const UploadLineDuotone = forwardRef<SVGSVGElement, UploadLineDuotoneProps>(
...
UploadLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
