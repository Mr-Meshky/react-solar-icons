...
interface ReorderBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const ReorderBoldDuotone = forwardRef<SVGSVGElement, ReorderBoldDuotoneProps>(
...
ReorderBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
