...
interface Login3OutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const Login3Outline = forwardRef<SVGSVGElement, Login3OutlineProps>(
...
Login3Outline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default Login3Outline;
