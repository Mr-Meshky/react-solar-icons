...
interface LoginBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const LoginBoldDuotone = forwardRef<SVGSVGElement, LoginBoldDuotoneProps>(
