...
interface UndoLeftRoundSquareBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const UndoLeftRoundSquareBroken = forwardRef<
  SVGSVGElement,
  UndoLeftRoundSquareBrokenProps
...
UndoLeftRoundSquareBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
