...
interface SendTwiceSquareOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SendTwiceSquareOutline = forwardRef<
  SVGSVGElement,
  SendTwiceSquareOutlineProps
...
SendTwiceSquareOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SendTwiceSquareOutline;
