...
interface ScreenShareLinearProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const ScreenShareLinear = forwardRef<SVGSVGElement, ScreenShareLinearProps>(
...
ScreenShareLinear.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
