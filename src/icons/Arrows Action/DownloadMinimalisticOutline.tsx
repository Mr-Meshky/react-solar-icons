...
interface DownloadMinimalisticOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const DownloadMinimalisticOutline = forwardRef<
  SVGSVGElement,
  DownloadMinimalisticOutlineProps
...
DownloadMinimalisticOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
