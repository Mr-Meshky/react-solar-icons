...
interface UndoLeftBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const UndoLeftBold = forwardRef<SVGSVGElement, UndoLeftBoldProps>(
...
UndoLeftBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default UndoLeftBold;
