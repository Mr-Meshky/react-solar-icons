...
interface MinimizeSquare3BoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const MinimizeSquare3BoldDuotone = forwardRef<
  SVGSVGElement,
  MinimizeSquare3BoldDuotoneProps
...
MinimizeSquare3BoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
