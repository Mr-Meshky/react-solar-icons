...
interface DownloadSquareOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const DownloadSquareOutline = forwardRef<
  SVGSVGElement,
  DownloadSquareOutlineProps
...
DownloadSquareOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
