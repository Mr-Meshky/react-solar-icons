...
interface UndoRightRoundOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const UndoRightRoundOutline = forwardRef<
  SVGSVGElement,
  UndoRightRoundOutlineProps
...
UndoRightRoundOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
