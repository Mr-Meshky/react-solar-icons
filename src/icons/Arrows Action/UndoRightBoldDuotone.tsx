...
interface UndoRightBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const UndoRightBoldDuotone = forwardRef<
  SVGSVGElement,
  UndoRightBoldDuotoneProps
...
UndoRightBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
