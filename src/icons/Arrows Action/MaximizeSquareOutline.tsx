...
interface MaximizeSquareOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const MaximizeSquareOutline = forwardRef<
  SVGSVGElement,
  MaximizeSquareOutlineProps
...
MaximizeSquareOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default MaximizeSquareOutline;
