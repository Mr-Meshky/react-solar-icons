...
interface UndoLeftRoundOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const UndoLeftRoundOutline = forwardRef<
  SVGSVGElement,
  UndoLeftRoundOutlineProps
...
UndoLeftRoundOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
