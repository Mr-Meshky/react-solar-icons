...
interface Logout3LineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const Logout3LineDuotone = forwardRef<SVGSVGElement, Logout3LineDuotoneProps>(
...
Logout3LineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
