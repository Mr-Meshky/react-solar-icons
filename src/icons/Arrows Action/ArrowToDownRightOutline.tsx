...
interface ArrowToDownRightOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const ArrowToDownRightOutline = forwardRef<
  SVGSVGElement,
  ArrowToDownRightOutlineProps
...
ArrowToDownRightOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
