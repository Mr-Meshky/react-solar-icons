...
interface ReciveSquareOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const ReciveSquareOutline = forwardRef<SVGSVGElement, ReciveSquareOutlineProps>(
...
ReciveSquareOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default ReciveSquareOutline;
