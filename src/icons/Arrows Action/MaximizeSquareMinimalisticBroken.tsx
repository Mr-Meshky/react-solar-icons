...
interface MaximizeSquareMinimalisticBrokenProps
...
const MaximizeSquareMinimalisticBroken = forwardRef<
  SVGSVGElement,
  MaximizeSquareMinimalisticBrokenProps
...
MaximizeSquareMinimalisticBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
