...
interface MaximizeSquare2OutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const MaximizeSquare2Outline = forwardRef<
  SVGSVGElement,
  MaximizeSquare2OutlineProps
...
MaximizeSquare2Outline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default MaximizeSquare2Outline;
