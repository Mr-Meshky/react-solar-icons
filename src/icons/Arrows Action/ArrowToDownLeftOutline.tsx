...
interface ArrowToDownLeftOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const ArrowToDownLeftOutline = forwardRef<
  SVGSVGElement,
  ArrowToDownLeftOutlineProps
...
ArrowToDownLeftOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
