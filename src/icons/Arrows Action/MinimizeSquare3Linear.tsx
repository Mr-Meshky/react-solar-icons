...
interface MinimizeSquare3LinearProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const MinimizeSquare3Linear = forwardRef<
  SVGSVGElement,
  MinimizeSquare3LinearProps
...
MinimizeSquare3Linear.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
