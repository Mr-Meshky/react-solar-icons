...
interface ArrowToTopRightBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const ArrowToTopRightBold = forwardRef<SVGSVGElement, ArrowToTopRightBoldProps>(
...
ArrowToTopRightBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
