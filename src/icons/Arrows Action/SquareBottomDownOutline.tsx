...
interface SquareBottomDownOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareBottomDownOutline = forwardRef<
  SVGSVGElement,
  SquareBottomDownOutlineProps
...
SquareBottomDownOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareBottomDownOutline;
