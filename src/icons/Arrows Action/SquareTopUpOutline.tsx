...
interface SquareTopUpOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareTopUpOutline = forwardRef<SVGSVGElement, SquareTopUpOutlineProps>(
...
SquareTopUpOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareTopUpOutline;
