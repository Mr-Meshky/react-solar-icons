...
interface DownloadMinimalisticBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const DownloadMinimalisticBoldDuotone = forwardRef<
  SVGSVGElement,
  DownloadMinimalisticBoldDuotoneProps
...
DownloadMinimalisticBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
