...
interface UploadTwiceSquareBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const UploadTwiceSquareBroken = forwardRef<
  SVGSVGElement,
  UploadTwiceSquareBrokenProps
...
UploadTwiceSquareBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
