...
interface MaximizeSquare3OutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const MaximizeSquare3Outline = forwardRef<
  SVGSVGElement,
  MaximizeSquare3OutlineProps
...
MaximizeSquare3Outline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default MaximizeSquare3Outline;
