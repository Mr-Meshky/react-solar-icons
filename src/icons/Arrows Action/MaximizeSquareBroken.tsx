...
interface MaximizeSquareBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const MaximizeSquareBroken = forwardRef<
  SVGSVGElement,
  MaximizeSquareBrokenProps
...
MaximizeSquareBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
