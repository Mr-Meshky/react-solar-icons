...
interface Login3LineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const Login3LineDuotone = forwardRef<SVGSVGElement, Login3LineDuotoneProps>(
...
Login3LineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
