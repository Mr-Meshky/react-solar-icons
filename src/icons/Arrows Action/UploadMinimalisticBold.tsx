...
interface UploadMinimalisticBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const UploadMinimalisticBold = forwardRef<
  SVGSVGElement,
  UploadMinimalisticBoldProps
...
UploadMinimalisticBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
