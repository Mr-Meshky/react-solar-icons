...
interface SendSquareBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SendSquareBroken = forwardRef<SVGSVGElement, SendSquareBrokenProps>(
