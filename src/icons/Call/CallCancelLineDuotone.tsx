...
interface CallCancelLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallCancelLineDuotone = forwardRef<
  SVGSVGElement,
  CallCancelLineDuotoneProps
...
CallCancelLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default CallCancelLineDuotone;
