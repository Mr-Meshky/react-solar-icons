...
interface CallCancelRoundedLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallCancelRoundedLineDuotone = forwardRef<
  SVGSVGElement,
  CallCancelRoundedLineDuotoneProps
...
CallCancelRoundedLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
