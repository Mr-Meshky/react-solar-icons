...
interface IncomingCallRoundedLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const IncomingCallRoundedLineDuotone = forwardRef<
  SVGSVGElement,
  IncomingCallRoundedLineDuotoneProps
>(({ variant, color = 'currentColor', size = 24, className, ...rest }, ref) => {
  return (
    <svg
      ...
      {...rest}
    >
      <path d="m19 5-4 4m0 0V6m0 3h3"></path>
      <path
...
IncomingCallRoundedLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
