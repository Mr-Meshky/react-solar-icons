...
interface OutgoingCallLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const OutgoingCallLineDuotone = forwardRef<
  SVGSVGElement,
  OutgoingCallLineDuotoneProps
...
OutgoingCallLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default OutgoingCallLineDuotone;
