...
interface CallDroppedRoundedOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallDroppedRoundedOutline = forwardRef<
  SVGSVGElement,
  CallDroppedRoundedOutlineProps
...
CallDroppedRoundedOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default CallDroppedRoundedOutline;
