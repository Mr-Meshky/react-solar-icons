...
interface CallDroppedLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallDroppedLineDuotone = forwardRef<
  SVGSVGElement,
  CallDroppedLineDuotoneProps
...
CallDroppedLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default CallDroppedLineDuotone;
