...
interface OutgoingCallBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const OutgoingCallBoldDuotone = forwardRef<
  SVGSVGElement,
  OutgoingCallBoldDuotoneProps
...
OutgoingCallBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
