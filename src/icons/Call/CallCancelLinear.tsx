...
interface CallCancelLinearProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallCancelLinear = forwardRef<SVGSVGElement, CallCancelLinearProps>(
