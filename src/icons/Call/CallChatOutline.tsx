...
interface CallChatOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallChatOutline = forwardRef<SVGSVGElement, CallChatOutlineProps>(
...
CallChatOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default CallChatOutline;
