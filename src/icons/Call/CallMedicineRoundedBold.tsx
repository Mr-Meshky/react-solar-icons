...
interface CallMedicineRoundedBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallMedicineRoundedBold = forwardRef<
  SVGSVGElement,
  CallMedicineRoundedBoldProps
...
CallMedicineRoundedBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
