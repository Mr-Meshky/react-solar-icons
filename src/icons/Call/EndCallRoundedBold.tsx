...
interface EndCallRoundedBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const EndCallRoundedBold = forwardRef<SVGSVGElement, EndCallRoundedBoldProps>(
...
EndCallRoundedBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
