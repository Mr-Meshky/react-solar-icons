...
interface IncomingCallBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const IncomingCallBoldDuotone = forwardRef<
  SVGSVGElement,
  IncomingCallBoldDuotoneProps
...
IncomingCallBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
