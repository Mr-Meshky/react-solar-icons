...
interface OutgoingCallRoundedLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const OutgoingCallRoundedLineDuotone = forwardRef<
  SVGSVGElement,
  OutgoingCallRoundedLineDuotoneProps
...
OutgoingCallRoundedLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
