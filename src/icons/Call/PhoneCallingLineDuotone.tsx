...
interface PhoneCallingLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const PhoneCallingLineDuotone = forwardRef<
  SVGSVGElement,
  PhoneCallingLineDuotoneProps
...
PhoneCallingLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default PhoneCallingLineDuotone;
