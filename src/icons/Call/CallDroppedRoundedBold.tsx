...
interface CallDroppedRoundedBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallDroppedRoundedBold = forwardRef<
  SVGSVGElement,
  CallDroppedRoundedBoldProps
...
CallDroppedRoundedBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
