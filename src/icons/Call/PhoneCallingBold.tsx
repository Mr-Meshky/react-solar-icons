...
interface PhoneCallingBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const PhoneCallingBold = forwardRef<SVGSVGElement, PhoneCallingBoldProps>(
...
PhoneCallingBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default PhoneCallingBold;
