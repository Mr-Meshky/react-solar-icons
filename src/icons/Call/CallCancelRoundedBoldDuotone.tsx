...
interface CallCancelRoundedBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallCancelRoundedBoldDuotone = forwardRef<
  SVGSVGElement,
  CallCancelRoundedBoldDuotoneProps
...
CallCancelRoundedBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
