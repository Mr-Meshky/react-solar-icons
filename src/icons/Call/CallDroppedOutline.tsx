...
interface CallDroppedOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallDroppedOutline = forwardRef<SVGSVGElement, CallDroppedOutlineProps>(
    ...
    return (
      ...
      >
        <path
          ...
          clip-rule="evenodd"
        ></path>
        <path d="M15.75 4a.75.75 0 1 0-1.5 0v1.052c0 .899 0 1.648.08 2.243.084.627.27 1.194.726 1.65s1.022.64 1.65.725c.46.062 1.014.076 1.657.08l-.831.664a.75.75 0 1 0 .937 1.172l2.5-2a.75.75 0 0 0 0-1.172l-2.5-2a.75.75 0 0 0-.937 1.172l.829.663c-.625-.003-1.088-.016-1.456-.066-.461-.062-.659-.169-.789-.3s-.237-.327-.3-.788c-.064-.483-.066-1.131-.066-2.095z"></path>
      </svg>
    );
  },
);

CallDroppedOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default CallDroppedOutline;
