...
interface CallDroppedRoundedBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallDroppedRoundedBoldDuotone = forwardRef<
  SVGSVGElement,
  CallDroppedRoundedBoldDuotoneProps
...
CallDroppedRoundedBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
