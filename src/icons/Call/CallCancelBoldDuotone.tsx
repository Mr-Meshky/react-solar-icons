...
interface CallCancelBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallCancelBoldDuotone = forwardRef<
  SVGSVGElement,
  CallCancelBoldDuotoneProps
...
CallCancelBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
