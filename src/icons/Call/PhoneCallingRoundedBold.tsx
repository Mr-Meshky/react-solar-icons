...
interface PhoneCallingRoundedBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const PhoneCallingRoundedBold = forwardRef<
  SVGSVGElement,
  PhoneCallingRoundedBoldProps
...
PhoneCallingRoundedBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default PhoneCallingRoundedBold;
