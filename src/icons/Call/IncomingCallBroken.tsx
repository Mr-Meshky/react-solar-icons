...
interface IncomingCallBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const IncomingCallBroken = forwardRef<SVGSVGElement, IncomingCallBrokenProps>(
