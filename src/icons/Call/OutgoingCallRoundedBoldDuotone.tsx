...
interface OutgoingCallRoundedBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const OutgoingCallRoundedBoldDuotone = forwardRef<
  SVGSVGElement,
  OutgoingCallRoundedBoldDuotoneProps
>(({ variant, color = 'currentColor', size = 24, className, ...rest }, ref) => {
  return (
    <svg
      ...
      {...rest}
    >
      <path d="m15 9 4-4m0 0v3m0-3h-3"></path>
      <path
...
OutgoingCallRoundedBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
