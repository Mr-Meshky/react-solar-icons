...
interface CallChatRoundedLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallChatRoundedLineDuotone = forwardRef<
  SVGSVGElement,
  CallChatRoundedLineDuotoneProps
...
CallChatRoundedLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
