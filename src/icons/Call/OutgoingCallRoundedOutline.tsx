...
interface OutgoingCallRoundedOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const OutgoingCallRoundedOutline = forwardRef<
  SVGSVGElement,
  OutgoingCallRoundedOutlineProps
  ...
  return (
    ...
    >
      <path
        ...
        clip-rule="evenodd"
      ></path>
      <path d="M16 4.25a.75.75 0 0 0 0 1.5h1.19l-2.72 2.72a.75.75 0 0 0 1.06 1.06l2.72-2.72V8a.75.75 0 0 0 1.5 0V5a.75.75 0 0 0-.75-.75z"></path>
    </svg>
  );
});

OutgoingCallRoundedOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default OutgoingCallRoundedOutline;
