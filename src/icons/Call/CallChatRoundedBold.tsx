...
interface CallChatRoundedBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallChatRoundedBold = forwardRef<SVGSVGElement, CallChatRoundedBoldProps>(
...
CallChatRoundedBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
