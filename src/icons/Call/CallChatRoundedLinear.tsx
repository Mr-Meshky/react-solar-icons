...
interface CallChatRoundedLinearProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallChatRoundedLinear = forwardRef<
  SVGSVGElement,
  CallChatRoundedLinearProps
...
CallChatRoundedLinear.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
