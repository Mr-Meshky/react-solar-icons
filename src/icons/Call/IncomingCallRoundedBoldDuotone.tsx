...
interface IncomingCallRoundedBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const IncomingCallRoundedBoldDuotone = forwardRef<
  SVGSVGElement,
  IncomingCallRoundedBoldDuotoneProps
...
IncomingCallRoundedBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
