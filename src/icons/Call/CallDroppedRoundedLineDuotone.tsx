...
interface CallDroppedRoundedLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallDroppedRoundedLineDuotone = forwardRef<
  SVGSVGElement,
  CallDroppedRoundedLineDuotoneProps
...
CallDroppedRoundedLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
