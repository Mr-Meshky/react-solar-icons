...
interface CallDroppedBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const CallDroppedBroken = forwardRef<SVGSVGElement, CallDroppedBrokenProps>(
