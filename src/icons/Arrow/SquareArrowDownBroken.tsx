...
interface SquareArrowDownBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowDownBroken = forwardRef<
  SVGSVGElement,
  SquareArrowDownBrokenProps
...
SquareArrowDownBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
