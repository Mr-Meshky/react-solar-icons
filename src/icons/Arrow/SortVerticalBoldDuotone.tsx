...
interface SortVerticalBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SortVerticalBoldDuotone = forwardRef<
  SVGSVGElement,
  SortVerticalBoldDuotoneProps
...
SortVerticalBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
