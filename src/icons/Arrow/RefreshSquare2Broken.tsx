...
interface RefreshSquare2BrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const RefreshSquare2Broken = forwardRef<
  SVGSVGElement,
  RefreshSquare2BrokenProps
...
RefreshSquare2Broken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
