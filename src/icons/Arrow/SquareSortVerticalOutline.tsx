...
interface SquareSortVerticalOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareSortVerticalOutline = forwardRef<
  SVGSVGElement,
  SquareSortVerticalOutlineProps
...
SquareSortVerticalOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareSortVerticalOutline;
