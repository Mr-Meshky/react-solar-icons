...
interface SquareArrowRightBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowRightBold = forwardRef<
  SVGSVGElement,
  SquareArrowRightBoldProps
...
SquareArrowRightBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
