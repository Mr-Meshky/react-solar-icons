...
interface DoubleAltArrowDownBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const DoubleAltArrowDownBold = forwardRef<
  SVGSVGElement,
  DoubleAltArrowDownBoldProps
...
DoubleAltArrowDownBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
