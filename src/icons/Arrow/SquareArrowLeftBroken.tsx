...
interface SquareArrowLeftBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowLeftBroken = forwardRef<
  SVGSVGElement,
  SquareArrowLeftBrokenProps
...
SquareArrowLeftBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
