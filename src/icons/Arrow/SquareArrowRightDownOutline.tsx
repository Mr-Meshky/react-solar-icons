...
interface SquareArrowRightDownOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowRightDownOutline = forwardRef<
  SVGSVGElement,
  SquareArrowRightDownOutlineProps
...
SquareArrowRightDownOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareArrowRightDownOutline;
