...
interface SquareSortHorizontalOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareSortHorizontalOutline = forwardRef<
  SVGSVGElement,
  SquareSortHorizontalOutlineProps
...
SquareSortHorizontalOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareSortHorizontalOutline;
