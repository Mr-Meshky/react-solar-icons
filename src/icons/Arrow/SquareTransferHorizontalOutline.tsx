...
interface SquareTransferHorizontalOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareTransferHorizontalOutline = forwardRef<
  SVGSVGElement,
  SquareTransferHorizontalOutlineProps
...
SquareTransferHorizontalOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareTransferHorizontalOutline;
