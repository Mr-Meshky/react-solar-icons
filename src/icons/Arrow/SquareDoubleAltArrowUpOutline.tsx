...
interface SquareDoubleAltArrowUpOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareDoubleAltArrowUpOutline = forwardRef<
  SVGSVGElement,
  SquareDoubleAltArrowUpOutlineProps
...
SquareDoubleAltArrowUpOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareDoubleAltArrowUpOutline;
