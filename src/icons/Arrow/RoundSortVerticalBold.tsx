...
interface RoundSortVerticalBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const RoundSortVerticalBold = forwardRef<
  SVGSVGElement,
  RoundSortVerticalBoldProps
...
RoundSortVerticalBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
