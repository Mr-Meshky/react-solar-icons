...
interface RefreshCircleLineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const RefreshCircleLineDuotone = forwardRef<
  SVGSVGElement,
  RefreshCircleLineDuotoneProps
...
RefreshCircleLineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
