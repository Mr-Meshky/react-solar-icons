...
interface SquareDoubleAltArrowRightOutlineProps
...
const SquareDoubleAltArrowRightOutline = forwardRef<
  SVGSVGElement,
  SquareDoubleAltArrowRightOutlineProps
...
SquareDoubleAltArrowRightOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareDoubleAltArrowRightOutline;
