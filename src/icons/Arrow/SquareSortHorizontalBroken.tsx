...
interface SquareSortHorizontalBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareSortHorizontalBroken = forwardRef<
  SVGSVGElement,
  SquareSortHorizontalBrokenProps
...
SquareSortHorizontalBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
