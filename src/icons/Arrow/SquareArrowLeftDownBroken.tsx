...
interface SquareArrowLeftDownBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowLeftDownBroken = forwardRef<
  SVGSVGElement,
  SquareArrowLeftDownBrokenProps
...
SquareArrowLeftDownBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
