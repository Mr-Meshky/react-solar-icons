...
interface SquareDoubleAltArrowLeftOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareDoubleAltArrowLeftOutline = forwardRef<
  SVGSVGElement,
  SquareDoubleAltArrowLeftOutlineProps
...
SquareDoubleAltArrowLeftOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareDoubleAltArrowLeftOutline;
