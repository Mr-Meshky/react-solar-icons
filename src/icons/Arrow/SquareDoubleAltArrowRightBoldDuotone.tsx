...
interface SquareDoubleAltArrowRightBoldDuotoneProps
...
const SquareDoubleAltArrowRightBoldDuotone = forwardRef<
  SVGSVGElement,
  SquareDoubleAltArrowRightBoldDuotoneProps
...
SquareDoubleAltArrowRightBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
