...
interface SquareArrowLeftUpOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowLeftUpOutline = forwardRef<
  SVGSVGElement,
  SquareArrowLeftUpOutlineProps
...
SquareArrowLeftUpOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareArrowLeftUpOutline;
