...
interface SquareSortVerticalBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareSortVerticalBroken = forwardRef<
  SVGSVGElement,
  SquareSortVerticalBrokenProps
...
SquareSortVerticalBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
