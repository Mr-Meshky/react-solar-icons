...
interface DoubleAltArrowUpBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const DoubleAltArrowUpBold = forwardRef<
  SVGSVGElement,
  DoubleAltArrowUpBoldProps
...
DoubleAltArrowUpBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
