...
interface SquareAltArrowDownOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareAltArrowDownOutline = forwardRef<
  SVGSVGElement,
  SquareAltArrowDownOutlineProps
...
SquareAltArrowDownOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareAltArrowDownOutline;
