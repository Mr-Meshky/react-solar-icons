...
interface RefreshCircleLinearProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const RefreshCircleLinear = forwardRef<SVGSVGElement, RefreshCircleLinearProps>(
...
RefreshCircleLinear.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
