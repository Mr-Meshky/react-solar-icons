...
interface SquareDoubleAltArrowDownOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareDoubleAltArrowDownOutline = forwardRef<
  SVGSVGElement,
  SquareDoubleAltArrowDownOutlineProps
...
SquareDoubleAltArrowDownOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareDoubleAltArrowDownOutline;
