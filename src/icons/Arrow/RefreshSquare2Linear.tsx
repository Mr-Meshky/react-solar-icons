...
interface RefreshSquare2LinearProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const RefreshSquare2Linear = forwardRef<
  SVGSVGElement,
  RefreshSquare2LinearProps
...
RefreshSquare2Linear.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
