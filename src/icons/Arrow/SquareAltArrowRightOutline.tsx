...
interface SquareAltArrowRightOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareAltArrowRightOutline = forwardRef<
  SVGSVGElement,
  SquareAltArrowRightOutlineProps
...
SquareAltArrowRightOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareAltArrowRightOutline;
