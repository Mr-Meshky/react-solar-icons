...
interface RefreshCircle2LinearProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const RefreshCircle2Linear = forwardRef<
  SVGSVGElement,
  RefreshCircle2LinearProps
...
RefreshCircle2Linear.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default RefreshCircle2Linear;
