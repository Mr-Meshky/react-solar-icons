...
interface RoundDoubleAltArrowRightOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const RoundDoubleAltArrowRightOutline = forwardRef<
  SVGSVGElement,
  RoundDoubleAltArrowRightOutlineProps
...
RoundDoubleAltArrowRightOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
