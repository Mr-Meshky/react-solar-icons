...
interface SquareArrowRightBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowRightBroken = forwardRef<
  SVGSVGElement,
  SquareArrowRightBrokenProps
...
SquareArrowRightBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
