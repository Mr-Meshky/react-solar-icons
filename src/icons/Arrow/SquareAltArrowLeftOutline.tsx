...
interface SquareAltArrowLeftOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareAltArrowLeftOutline = forwardRef<
  SVGSVGElement,
  SquareAltArrowLeftOutlineProps
...
SquareAltArrowLeftOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareAltArrowLeftOutline;
