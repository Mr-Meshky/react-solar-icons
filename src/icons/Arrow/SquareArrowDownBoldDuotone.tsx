...
interface SquareArrowDownBoldDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowDownBoldDuotone = forwardRef<
  SVGSVGElement,
  SquareArrowDownBoldDuotoneProps
...
SquareArrowDownBoldDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
