...
interface SquareArrowLeftDownOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowLeftDownOutline = forwardRef<
  SVGSVGElement,
  SquareArrowLeftDownOutlineProps
...
SquareArrowLeftDownOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareArrowLeftDownOutline;
