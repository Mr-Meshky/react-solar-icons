...
interface SquareArrowLeftUpBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowLeftUpBroken = forwardRef<
  SVGSVGElement,
  SquareArrowLeftUpBrokenProps
...
SquareArrowLeftUpBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
