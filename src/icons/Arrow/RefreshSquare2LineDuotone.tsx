...
interface RefreshSquare2LineDuotoneProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const RefreshSquare2LineDuotone = forwardRef<
  SVGSVGElement,
  RefreshSquare2LineDuotoneProps
...
RefreshSquare2LineDuotone.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default RefreshSquare2LineDuotone;
