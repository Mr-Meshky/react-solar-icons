...
interface SquareArrowRightUpOutlineProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowRightUpOutline = forwardRef<
  SVGSVGElement,
  SquareArrowRightUpOutlineProps
...
SquareArrowRightUpOutline.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};

export default SquareArrowRightUpOutline;
