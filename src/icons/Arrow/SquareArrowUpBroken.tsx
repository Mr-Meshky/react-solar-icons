...
interface SquareArrowUpBrokenProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareArrowUpBroken = forwardRef<SVGSVGElement, SquareArrowUpBrokenProps>(
...
SquareArrowUpBroken.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
