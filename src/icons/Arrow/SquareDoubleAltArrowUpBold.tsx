...
interface SquareDoubleAltArrowUpBoldProps extends SVGProps<SVGSVGElement> {
  variant?: string;
  color?: string;
  size?: string | number;
  className?: string;
...
const SquareDoubleAltArrowUpBold = forwardRef<
  SVGSVGElement,
  SquareDoubleAltArrowUpBoldProps
...
SquareDoubleAltArrowUpBold.defaultProps = {
  variant: 'Linear',
  color: 'currentColor',
  size: 24,
};
